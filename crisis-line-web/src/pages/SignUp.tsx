              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`block w-full rounded-xl border bg-gray-50/50 pl-10 pr-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-300 focus:ring-2 focus:bg-white transition-all outline-none ${
                      !passwordsMatch
